...
i(@b.xr4.brend[i])"}
T {NOTE: These are DUTY CYCLES (pixel durations), not periods.} 220 -190 0 0 0.4 0.4 {}
N 1980 -150 2020 -150 {
lab=vdac4pin}
N 2100 -30 2100 -10 {
lab=GND}
...
C {devices/lab_pin.sym} 270 -580 0 0 {name=p3 sig_type=std_logic lab=v040n}
...
C {devices/lab_pin.sym} 270 -480 0 0 {name=p5 sig_type=std_logic lab=v080n}
...
C {devices/lab_pin.sym} 270 -380 0 0 {name=p6 sig_type=std_logic lab=v160n}
...
C {devices/lab_pin.sym} 270 -280 0 0 {name=p31 sig_type=std_logic lab=v320n}
...
C {devices/lab_pin.sym} 530 -580 0 0 {name=p32 sig_type=std_logic lab=v640n}
C {devices/gnd.sym} 270 -220 0 0 {name=l35 lab=GND}
C {devices/vsource.sym} 530 -550 0 0 {name=V8 value="pulse 1.8v 0v 0n 1n 1n 639n 1280n"  savecurrent=false}
C {devices/lab_pin.sym} 530 -480 0 0 {name=p33 sig_type=std_logic lab=v1280n}
C {devices/gnd.sym} 530 -520 0 0 {name=l36 lab=GND}
C {devices/vsource.sym} 530 -450 0 0 {name=V9 value="pulse 1.8v 0v 0n 1n 1n 1279n 2560n"  savecurrent=false}
C {devices/lab_pin.sym} 530 -380 0 0 {name=p34 sig_type=std_logic lab=v2560n}
C {devices/gnd.sym} 530 -420 0 0 {name=l38 lab=GND}
C {devices/vsource.sym} 530 -350 0 0 {name=V10 value="pulse 1.8v 0v 0n 1n 1n 2559n 5120n"  savecurrent=false}
C {devices/lab_pin.sym} 530 -280 0 0 {name=p35 sig_type=std_logic lab=v5120n}
C {devices/gnd.sym} 530 -320 0 0 {name=l39 lab=GND}
...
C {devices/lab_pin.sym} 270 -680 0 0 {name=p4 sig_type=std_logic lab=v020n}
C {devices/vsource.sym} 530 -250 0 0 {name=V11 value="pulse 1.8v 0v 0n 1n 1n 5119n 10240n"  savecurrent=false}
